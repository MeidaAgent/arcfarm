...
class Handler(http.server.SimpleHTTPRequestHandler):
    ...
    def _api(self, method):
        ...
        q = parse_qs(u.query)
        return chat.handle(self, method, u.path, q, body) or players.handle(self, method, u.path, q, body) or whitelist.handle(self, method, u.path, q, body)
...
if __name__ == "__main__":
    ...
    with Server((args.host, args.port), Handler) as httpd:
        ...
        print(f"ARC FARM: http://{where}:{args.port}{Handler.url_base}/  (root: {Handler.serve_root})")
