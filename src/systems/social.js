...
export const GIFT_REPLY = {
  love: ['This is my favorite! Thank you so much.', 'Wow, you remembered I love this?'],
  like: ['Thank you, I like this.', 'That is so kind of you.'],
  neutral: ['Thank you.', 'Oh, this is nice. Thanks.'],
  dislike: ['Uh... thanks. I guess.', 'Hmm. Alright, thanks.'],
};
