...
export const AVATARS = [
  { id: 'player_m', label: 'Alex' },
  { id: 'player_f', label: 'Emily' },
  { id: 'player_m2', label: 'Daniel' },
  { id: 'player_f2', label: 'Sophia' },
];
...
export function readSave(slot = 0) {
  ...
  if (v > SAVE_VERSION) throw new Error(`Save from a newer version (${v})`);
