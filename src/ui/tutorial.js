...
const STEPS = [
  { id: 'walk', label: 'Walk: WASD / arrows' },
  { id: 'gate', label: 'Enter the garden plots' },
  { id: 'till', label: 'Hoe the soil (tool 1)' },
  { id: 'plant', label: 'Plant seeds (tool 6)' },
  { id: 'water', label: 'Water crops (tool 5)' },
  { id: 'sleep', label: 'Sleep in front of the house' },
];
...
export class Tutorial {
  ...
  draw(ctx) {
    ...
    text(ctx, 'DAY 1 GUIDE', x + w / 2, y + 14, {
    ...
    text(ctx, 'H  hide', x + w / 2, y + h - 34, { font: UI.font, align: 'center', color: '#7a6647' });
  }
